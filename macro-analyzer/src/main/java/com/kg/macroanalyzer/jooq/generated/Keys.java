...
import com.kg.macroanalyzer.jooq.generated.tables.records.EuroMarket_10YearNetherlandsRecord;
...
import com.kg.macroanalyzer.jooq.generated.tables.records.EuroMarket_5YearGbRecord;
...
import com.kg.macroanalyzer.jooq.generated.tables.records.EuroMarket_5YearNetherlandsRecord;
...
public class Keys {
    ...
    public static final UniqueKey<EuroMarket_10YearDenmarkRecord> EURO_MARKET_10_YEAR_DENMARK_PKEY = Internal.createUniqueKey(EuroMarket_10YearDenmark.EURO_MARKET_10_YEAR_DENMARK, DSL.name("euro_market_10_year_denmark_pkey"), new TableField[] { EuroMarket_10YearDenmark.EURO_MARKET_10_YEAR_DENMARK.ID }, true);
    public static final UniqueKey<EuroMarket_10YearEurRecord> EURO_MARKET_10_YEAR_EUR_PKEY = Internal.createUniqueKey(EuroMarket_10YearEur.EURO_MARKET_10_YEAR_EUR, DSL.name("euro_market_10_year_eur_pkey"), new TableField[] { EuroMarket_10YearEur.EURO_MARKET_10_YEAR_EUR.ID }, true);
    public static final UniqueKey<EuroMarket_10YearFinlandRecord> EURO_MARKET_10_YEAR_FINLAND_PKEY = Internal.createUniqueKey(EuroMarket_10YearFinland.EURO_MARKET_10_YEAR_FINLAND, DSL.name("euro_market_10_year_finland_pkey"), new TableField[] { EuroMarket_10YearFinland.EURO_MARKET_10_YEAR_FINLAND.ID }, true);
    public static final UniqueKey<EuroMarket_10YearFranceRecord> EURO_MARKET_10_YEAR_FRANCE_PKEY = Internal.createUniqueKey(EuroMarket_10YearFrance.EURO_MARKET_10_YEAR_FRANCE, DSL.name("euro_market_10_year_france_pkey"), new TableField[] { EuroMarket_10YearFrance.EURO_MARKET_10_YEAR_FRANCE.ID }, true);
    public static final UniqueKey<EuroMarket_10YearGbRecord> EURO_MARKET_10_YEAR_GB_PKEY = Internal.createUniqueKey(EuroMarket_10YearGb.EURO_MARKET_10_YEAR_GB, DSL.name("euro_market_10_year_gb_pkey"), new TableField[] { EuroMarket_10YearGb.EURO_MARKET_10_YEAR_GB.ID }, true);
    public static final UniqueKey<EuroMarket_10YearGermanyRecord> EURO_MARKET_10_YEAR_GERMANY_PKEY = Internal.createUniqueKey(EuroMarket_10YearGermany.EURO_MARKET_10_YEAR_GERMANY, DSL.name("euro_market_10_year_germany_pkey"), new TableField[] { EuroMarket_10YearGermany.EURO_MARKET_10_YEAR_GERMANY.ID }, true);
    public static final UniqueKey<EuroMarket_10YearJapanRecord> EURO_MARKET_10_YEAR_JAPAN_PKEY = Internal.createUniqueKey(EuroMarket_10YearJapan.EURO_MARKET_10_YEAR_JAPAN, DSL.name("euro_market_10_year_japan_pkey"), new TableField[] { EuroMarket_10YearJapan.EURO_MARKET_10_YEAR_JAPAN.ID }, true);
    public static final UniqueKey<EuroMarket_10YearNetherlandsRecord> EURO_MARKET_10_YEAR_NETHERLANDS_PKEY = Internal.createUniqueKey(EuroMarket_10YearNetherlands.EURO_MARKET_10_YEAR_NETHERLANDS, DSL.name("euro_market_10_year_netherlands_pkey"), new TableField[] { EuroMarket_10YearNetherlands.EURO_MARKET_10_YEAR_NETHERLANDS.ID }, true);
    public static final UniqueKey<EuroMarket_10YearNorwayRecord> EURO_MARKET_10_YEAR_NORWAY_PKEY = Internal.createUniqueKey(EuroMarket_10YearNorway.EURO_MARKET_10_YEAR_NORWAY, DSL.name("euro_market_10_year_norway_pkey"), new TableField[] { EuroMarket_10YearNorway.EURO_MARKET_10_YEAR_NORWAY.ID }, true);
    public static final UniqueKey<EuroMarket_10YearUsaRecord> EURO_MARKET_10_YEAR_USA_PKEY = Internal.createUniqueKey(EuroMarket_10YearUsa.EURO_MARKET_10_YEAR_USA, DSL.name("euro_market_10_year_usa_pkey"), new TableField[] { EuroMarket_10YearUsa.EURO_MARKET_10_YEAR_USA.ID }, true);
    ...
    public static final UniqueKey<EuroMarket_5YearEurRecord> EURO_MARKET_5_YEAR_EUR_PKEY = Internal.createUniqueKey(EuroMarket_5YearEur.EURO_MARKET_5_YEAR_EUR, DSL.name("euro_market_5_year_eur_pkey"), new TableField[] { EuroMarket_5YearEur.EURO_MARKET_5_YEAR_EUR.ID }, true);
    public static final UniqueKey<EuroMarket_5YearFranceRecord> EURO_MARKET_5_YEAR_FRANCE_PKEY = Internal.createUniqueKey(EuroMarket_5YearFrance.EURO_MARKET_5_YEAR_FRANCE, DSL.name("euro_market_5_year_france_pkey"), new TableField[] { EuroMarket_5YearFrance.EURO_MARKET_5_YEAR_FRANCE.ID }, true);
    public static final UniqueKey<EuroMarket_5YearGbRecord> EURO_MARKET_5_YEAR_GB_PKEY = Internal.createUniqueKey(EuroMarket_5YearGb.EURO_MARKET_5_YEAR_GB, DSL.name("euro_market_5_year_gb_pkey"), new TableField[] { EuroMarket_5YearGb.EURO_MARKET_5_YEAR_GB.ID }, true);
    public static final UniqueKey<EuroMarket_5YearGermanyRecord> EURO_MARKET_5_YEAR_GERMANY_PKEY = Internal.createUniqueKey(EuroMarket_5YearGermany.EURO_MARKET_5_YEAR_GERMANY, DSL.name("euro_market_5_year_germany_pkey"), new TableField[] { EuroMarket_5YearGermany.EURO_MARKET_5_YEAR_GERMANY.ID }, true);
    public static final UniqueKey<EuroMarket_5YearJapanRecord> EURO_MARKET_5_YEAR_JAPAN_PKEY = Internal.createUniqueKey(EuroMarket_5YearJapan.EURO_MARKET_5_YEAR_JAPAN, DSL.name("euro_market_5_year_japan_pkey"), new TableField[] { EuroMarket_5YearJapan.EURO_MARKET_5_YEAR_JAPAN.ID }, true);
    public static final UniqueKey<EuroMarket_5YearNetherlandsRecord> EURO_MARKET_5_YEAR_NETHERLANDS_PKEY = Internal.createUniqueKey(EuroMarket_5YearNetherlands.EURO_MARKET_5_YEAR_NETHERLANDS, DSL.name("euro_market_5_year_netherlands_pkey"), new TableField[] { EuroMarket_5YearNetherlands.EURO_MARKET_5_YEAR_NETHERLANDS.ID }, true);
    public static final UniqueKey<EuroMarket_5YearUsaRecord> EURO_MARKET_5_YEAR_USA_PKEY = Internal.createUniqueKey(EuroMarket_5YearUsa.EURO_MARKET_5_YEAR_USA, DSL.name("euro_market_5_year_usa_pkey"), new TableField[] { EuroMarket_5YearUsa.EURO_MARKET_5_YEAR_USA.ID }, true);
