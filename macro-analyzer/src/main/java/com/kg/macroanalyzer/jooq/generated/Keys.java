...
public class Keys {
    ...
    public static final UniqueKey<EuroMarket_5YearDenmarkRecord> EURO_MARKET_5_YEAR_DENMARK_PKEY = Internal.createUniqueKey(EuroMarket_5YearDenmark.EURO_MARKET_5_YEAR_DENMARK, DSL.name("euro_market_5_year_denmark_pkey"), new TableField[] { EuroMarket_5YearDenmark.EURO_MARKET_5_YEAR_DENMARK.ID }, true);
    ...
    public static final UniqueKey<EuroMarket_5YearNorwayRecord> EURO_MARKET_5_YEAR_NORWAY_PKEY = Internal.createUniqueKey(EuroMarket_5YearNorway.EURO_MARKET_5_YEAR_NORWAY, DSL.name("euro_market_5_year_norway_pkey"), new TableField[] { EuroMarket_5YearNorway.EURO_MARKET_5_YEAR_NORWAY.ID }, true);
